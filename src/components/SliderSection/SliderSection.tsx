...
export const SliderSection:React.FC = () => {
  const [slides] = useState([
    ...
    {
      title: 'как потом сплятался🙈',
      image: fifth,
    },
    {
      title: 'как мы гуляли по городу всю ночь и встретили рассвет возле речки? Ты сказал, что это теперь будет нашим местом ...',
      image: sixth,
    },
    {
    ...
    {
      title: 'какой у нас был крутой отель и как мы ахреневали каждый раз, как заходили внутрь?',
      image: eighth,
    },
    {
    ...
    {
      title: 'как нас фотографировала женщина и сказала "прижмись к ней ближе, что вы как неженаты", мы посмеялись и ответили, что мы и так не женаты 🙃 "тогда точно поженитесь" ответила она',
      image: sixteenth,
    },
    {
  ...
  return (
    <section className="section section--slider">
      <div className="slider">
        ...
        <Star
          text="Я благодарна тебе за твою защиту, заботу и нежность, которую ты даришь мне в самое необходимое для меня время"
          classNamePart="4"
        />
        <Star
